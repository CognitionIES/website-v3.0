      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="mb-10">
          ...
          <p className="mt-3 text-base sm:text-lg text-gray-500 max-w-2xl leading-relaxed">
            The context that shaped the engagement and the core problem
            Cognition IES was brought in to solve.
          </p>
        </div>
          ...
          <div className="space-y-5 text-justify">
            ...
            <div className="grid grid-cols-2 gap-4 pt-2">
              {[
                ...
                <div
                  key={s.label}
                  className="p-4 bg-[#E6F0F5]/40 rounded-xl border border-[#E6F0F5]"
                >
