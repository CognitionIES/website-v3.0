...
const services: Svc[] = [
  ...
  },
  {
    ...
    subCategories: [
      { title: "Pre-FEED",                href: "/services/plant-engineering#phase-01", icon: <FileText className="w-3 h-3" /> },
      { title: "FEED",                    href: "/services/plant-engineering#phase-02", icon: <Workflow className="w-3 h-3" /> },
      { title: "Basic Engineering",       href: "/services/plant-engineering#phase-03", icon: <FontAwesomeIcon icon={faGears} className="w-3 h-3" /> },
      { title: "Detailed Engineering",    href: "/services/plant-engineering#phase-04", icon: <Layers className="w-3 h-3" /> },
      { title: "Specialized Engineering", href: "/services/plant-engineering#phase-05", icon: <FontAwesomeIcon icon={faChartArea} className="w-3 h-3" /> },
      { title: "Digitalization",          href: "/services/plant-engineering#phase-06", icon: <Server className="w-3 h-3" /> },
    ],
  },
  {
